    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_attack_result, container, false).also {
            it.findViewById<AppCompatButton>(R.id.attackResult_btn1)
                .setOnClickListener { findNavController().navigate(R.id.action_attackResultFragment_to_attackFoulFragment) }
            it.findViewById<AppCompatButton>(R.id.attackResult_btn2)
                .setOnClickListener { findNavController().navigate(R.id.action_attackResultFragment_to_attackFinishTypeFragment) }
            it.findViewById<AppCompatButton>(R.id.attackResult_btn3)
                .setOnClickListener { findNavController().navigate(R.id.action_attackResultFragment_to_attackLostFragment) }
